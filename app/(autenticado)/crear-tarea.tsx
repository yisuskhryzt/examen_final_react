...
export default function CrearTareaScreen() {
  ...
  const { crearTarea, cargando: cargandoTarea } = useTareas();
  ...
  const hayDatos = titulo.trim() !== '' || ubicacion !== null || urlImagenSubida !== null;
  ...
  const manejarVolver = () => {
    ...
    Alert.alert(
      'Descartar cambios',
      '¿Desea abandonar la carga de la tarea?',
      [
      ...
      <View style={estilos.formulario}>
        ...
        >
          {cargandoTarea ? (
            ...
            <Text style={estilos.textoBotonGuardar}>Crear Tarea</Text>
          )}
        </TouchableOpacity>
